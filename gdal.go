...
func (sourceRaster RasterBand) RasterBandCopyWholeRaster(
	...
	return CPLErr(
		C.GDALRasterBandCopyWholeRaster(
			sourceRaster.cval,
			destRaster.cval,
			(**C.char)(unsafe.Pointer(&cOptions[0])),
			C.goGDALProgressFuncProxyB(),
